...
errors = []
err_type=[]
BASE = "/home/shared/projects/oct_segmentation_rds/data/raw/val"
...
for file in files:
    if file.endswith("dcm"):
        ...
        segs = glob.glob(f'/home/shared/projects/oct_segmentation_rds/data/raw/val/{seg_search}')
        if len(segs) < 1:
            errors.append(file)
...
log.to_csv("segmentation_val_errors.csv")
